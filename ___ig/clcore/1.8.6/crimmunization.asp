...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.6/Immunization-999.html");
  else if (id == "ImmunizationCL")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.6/Immunization-ImmunizationCL.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.6/crimmunization.asp) .
</body>
</html>
