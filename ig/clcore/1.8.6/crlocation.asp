...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.6/Location-LocalizacionEjemploCL1.html");
  else if (id == "3333458")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.6/Location-3333458.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.6/crlocation.asp) .
</body>
</html>
