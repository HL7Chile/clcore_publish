...
<%
  ...
  else if (id == "DiagnosticoEj2")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.9.1/Condition-DiagnosticoEj2.html");
  else if (id == "DiagnosticoEj")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.9.1/Condition-DiagnosticoEj.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.9.1/crcondition.asp) .
</body>
</html>
