...
<%
  ...
  else if (id == "EjemploEncounterCL")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.9.1/Encounter-EjemploEncounterCL.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.9.1/crencounter.asp) .
</body>
</html>
