...
<%
  ...
  else if (id == "AllergyIntoleranceEj")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.9.1/AllergyIntolerance-AllergyIntoleranceEj.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.9.1/crallergyintolerance.asp) .
</body>
</html>
