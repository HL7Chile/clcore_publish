...
<%
  ...
  else if (id == "DocumentoEjemplo1")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.9.1/Composition-DocumentoEjemplo1.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.9.1/crcomposition.asp) .
</body>
</html>
