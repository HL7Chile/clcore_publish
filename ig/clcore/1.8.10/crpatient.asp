...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Patient-PacienteCL.html");
  else if (id == "11")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Patient-11.html");
  else if (id == "PacienteCl-4")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Patient-PacienteCl-4.html");
  else if (id == "PacienteCl-3")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Patient-PacienteCl-3.html");
  else if (id == "PacienteCL2")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Patient-PacienteCL2.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.10/crpatient.asp) .
</body>
</html>
