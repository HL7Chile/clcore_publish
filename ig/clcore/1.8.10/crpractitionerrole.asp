...
<%
  ...
  else if (id == "EspecialidadCL")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/PractitionerRole-EspecialidadCL.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.10/crpractitionerrole.asp) .
</body>
</html>
