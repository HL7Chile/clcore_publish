...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Practitioner-3020.html");
  else if (id == "3240")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Practitioner-3240.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.10/crpractitioner.asp) .
</body>
</html>
