...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Condition-DiagnosticoEj.html");
  else if (id == "1112")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.10/Condition-1112.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.10/crcondition.asp) .
</body>
</html>
