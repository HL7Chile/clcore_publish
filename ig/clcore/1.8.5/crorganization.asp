...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.5/Organization-f003.html");
  else if (id == "ORG1")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.5/Organization-ORG1.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.5/crorganization.asp) .
</body>
</html>
