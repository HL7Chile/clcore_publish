...
<%
  ...
  else if (id == "CompositionCl-CarlosSalas")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.5/Composition-CompositionCl-CarlosSalas.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.5/crcomposition.asp) .
</body>
</html>
