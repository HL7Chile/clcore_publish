...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.5/Medication-MedicamentoCl-2.html");
  else if (id == "MedicamentoCl")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.5/Medication-MedicamentoCl.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.5/crmedication.asp) .
</body>
</html>
